 ...
 * 
 */
@WebServiceClient(name = "WebServicesService", targetNamespace = "http://publish.altoViaje/", wsdlLocation = "http://localhost:9139/webservices?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESSERVICE_QNAME = new QName("http://publish.altoViaje/", "WebServicesService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9139/webservices?wsdl");
    ...
    public WebServices getWebServicesPort() {
        return super.getPort(new QName("http://publish.altoViaje/", "WebServicesPort"), WebServices.class);
    }
    ...
    public WebServices getWebServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://publish.altoViaje/", "WebServicesPort"), WebServices.class, features);
    }
